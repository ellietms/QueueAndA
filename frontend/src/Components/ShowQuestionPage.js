...
const ShowQuestionPage = (props) => {
	...
	return (
		<div>
			<Header value={searchValue} handleSearchValue={(newSearchValue) => setSearchValue(newSearchValue)} />
			<div className="container mt-5 mb-2">
				<QuestionBox questionDetails={specificQuestion} />
			</div>
			<div>
				<Checked questionDetails={specificQuestion.answers} />
				<Answers questionDetails={specificQuestion.answers} searchValue={searchValue} />
			</div>
			<div>
